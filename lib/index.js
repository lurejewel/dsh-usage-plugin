...
export function apply(ctx) {
  // Registrations are effects: wrap each route in ctx.effect so the routes are
  // removed (not left as zombie handlers against a dead context) when the
  // plugin is unloaded — HMR, profile hot-reapply, or uninstall.
  ...
  }), 'dsh-usage-plugin: balance route')
